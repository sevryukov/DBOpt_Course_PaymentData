...
BEGIN
  ...
  UPDATE dbo.Payment SET Amount = 123, Category = @r_category, Project = @r_project, Comment = 'test_gen', Payer = @r_payer, Payee = @r_payee, GCRecord = NULL WHERE Oid = @r_payment
